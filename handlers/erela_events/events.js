            ...
            if (i.customId == `4`) {
              ...
              i.reply({
                embeds: [new MessageEmbed()
                  .setColor(es.color)
                  .setTimestamp()
                  .setTitle(`${player.get(`autoplay`) ? `<:813386223891644436:839306287958851635> <:yap:840786958414118913>   **Enabled Autoplay**`: `❌ **Disabled Autoplay**`}`)
                  .setFooter(client.getFooter(`💢 Action by: ${member.user.tag}`, member.user.displayAvatarURL({
                    dynamic: true
                  })))
                ]
            ...
            if (i.customId == `6`) {
              ...
              i.reply({
                embeds: [new MessageEmbed()
                  .setColor(es.color)
                  .setTimestamp()
                  .setTitle(`${player.trackRepeat ? `<:813386223891644436:839306287958851635> <:yap:840786958414118913>   **Enabled Song Loop**`: `❌ **Disabled Song Loop**`}`)
                  .setFooter(client.getFooter(`💢 Action by: ${member.user.tag}`, member.user.displayAvatarURL({
                    dynamic: true
                  })))
                ]
            ...
            if (i.customId == `7`) {
              ...
              i.reply({
                embeds: [new MessageEmbed()
                  .setColor(es.color)
                  .setTimestamp()
                  .setTitle(`${player.queueRepeat ? `<:813386223891644436:839306287958851635> <:yap:840786958414118913>   **Enabled Queue Loop**`: `❌ **Disabled Queue Loop**`}`)
                  .setFooter(client.getFooter(`💢 Action by: ${member.user.tag}`, member.user.displayAvatarURL({
                    dynamic: true
                  })))
                ]
