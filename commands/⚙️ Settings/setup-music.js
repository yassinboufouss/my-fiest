  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls) => {
    ...
    var embeds = [
      ...
      .setImage(message.guild.banner ? message.guild.bannerURL({
        size: 4096
      }) : "https://cdn.discordapp.com/attachments/951092930746130432/1086391571534073896/standard.gif")
      .setTitle(`Start Listening to Music, by connecting to a Voice Channel and sending either the **SONG LINK** or **SONG NAME** in this Channel!`)
      .setDescription(`> *I support <:Youtube:865714608686104637> Youtube, <:Spotify:865714609792614420> Spotify, <:4544_SN_Soundcloud_512x512:840662089873358848> Soundcloud and direct MP3 Links!*`)
    ]
    var Emojis = [
      "0️⃣",
      "1️⃣",
